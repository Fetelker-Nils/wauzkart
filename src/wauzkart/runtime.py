...
from PyQt5.QtCore import QTimer, Qt, QUrl, QSize, QPoint, QObject, pyqtSignal
from PyQt5.QtGui import QFont, QColor, QPainter, QPen, QIcon, QPixmap, QBrush, QDesktopServices
try:
